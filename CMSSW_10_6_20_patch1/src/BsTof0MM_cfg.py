...
# with command line options: Configuration/GenProduction/python/BsTof0MM.py --python_filename BsTof0MM_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN --fileout file:BsTof0MM.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 100000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BsTof0MM.py nevts:100000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BsTof0MM.root'),
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring(
                '#', 
                '# This is the decay file for the decay BS0 -> MU+ MU- F0(-> pi+ pi-)', 
                '#', 
                'Alias      MyB_s0   B_s0', 
                'Alias      Myanti-B_s0   anti-B_s0', 
                'ChargeConj Myanti-B_s0   MyB_s0', 
                "Alias      Myf0    f\'_0", 
                "ChargeConj Myf0    f\'_0", 
                '#', 
                'Decay MyB_s0', 
